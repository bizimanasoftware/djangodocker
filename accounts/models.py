...
class CustomUser(AbstractUser):
    ...
    class UserType(models.TextChoices):
        ...
        VOLLEYBALLER = 'VOLLEYBALLER', 'Volleyballer'
 ...
 # Add other user types here as your project grows
    ...
    def get_dashboard_url(self):
        ...
        elif self.user_type == self.UserType.INFLUENCER:
            return reverse('influencers:dashboard')
        elif self.user_type == self.UserType.FILMMAKER:
            return reverse('filmmakers:dashboard')
        elif self.user_type == self.UserType.COMEDIAN:
            return reverse('comedians:dashboard')
        elif self.user_type == self.UserType.VOLLEYBALLER:
            return reverse('volleyballers:dashboard')
        elif self.user_type == self.UserType.VOLUNTEER:
            return reverse('volunteers:dashboard')
        elif self.user_type == self.UserType.JOURNALIST:
            return reverse('journalists:dashboard')
        elif self.user_type == self.UserType.TRADER:
            return reverse('traders:dashboard')
        elif self.user_type == self.UserType.BOXER:
            return reverse('boxers:dashboard')
        elif self.user_type == self.UserType.DONOR:
            return reverse('donors:dashboard')
        elif self.user_type == self.UserType.OTHER:
            return reverse('others:dashboard')
